...
During our evaluation in Chapter~\ref{ch:evaluation}, we used Devito abstraction to effortlessly generate entire families of stencils by varying the space order of a differential equation; producing these stencils from the equations is decidedly non-trivial, and would have otherwise been extremely time-consuming.
...
\begin{itemize}
	...
	We determined the performance of the estimators under various conditions, and used our estimator to demonstrate that the evaluated stencils were still bound by memory bandwidth.
...
This would enable a more realistic model, although some sacrifices may be necessary with regards to overestimation.
