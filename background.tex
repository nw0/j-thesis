...
\wip{Mention that we are considering hypercube-like iteration spaces}
...
\wip{Definition here could be clearer}
...
\wip{Verify that these problems were indeed discussed later}
...
\clar{Should I explicitly mention dependence vectors? Would have to define them.}
