...
\wip{Mention that we are considering hypercube-like iteration spaces + time}
...
Failure to preserve this dependence, is known as \emph{dependency violation}, which occurs when we are unable to complete a calculation, as it would either overwrite data still required, or require data that has not been calculated yet.
