...
Section~\ref{sec:perf-laplace} examines results under the Laplace operator, and Section~\ref{sec:perf-awe} the acoustic wave equation.
Finally, we discuss limitations of our performance testing (Section~\ref{sec:perf-limitations}), and consider further work in evaluation (Section~\ref{sec:further-eval}).
...
The \emph{LINPACK} benchmark~\cite{linpack}, highly optimised and likely to perform faster than any stencil we evaluate, achieves a maximum of 131 GFlops on this machine.
