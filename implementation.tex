...
Having previously seen the concepts of time-tiling and the relevant components of Devito, this chapter presents our implementation of time-tiling in Devito, with reference to the design choices made.
...
\begin{description}
	...
	\begin{itemize}
		...
		\item Removal of (2) test cases specifically testing remainder loops
