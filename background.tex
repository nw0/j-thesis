...
This forms the basis and context for the entire report, and in particular the survey of related work, which composes the remainder of this chapter (from Section~\ref{sec:pochoir}).
...
While the concepts behind it may be sound and applicable in specific circumstances, it would be an unsuitable basis for this investigation.
