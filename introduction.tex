...
\begin{itemize}
	...
	\item Demonstration of a runtime decrease of up to 25\% due to the application of time-tiling in Devito.
	An evaluation on the conditions for maximising the performance increase.
