...
\clar{Target audience? `People who know about PDEs and computing them'?}

\wip{(How) is this \emph{truly} exciting?}
...
One of the challenges faced by those using differential equations to generate new models is the time necessary to translate differential equations into stencils and then code for computation.
