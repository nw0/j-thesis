...
\end{axis}
\end{tikzpicture}
\caption{Graph of performance against arithmetic intensity for the Laplace operator, grid size \(16 \times 600^3\). As predicted by the roofline model, GFlops achieved increases for stencils of lower arithmetic intensity, but tapers off as arithmetic increases.}
...
However, we would be wary of drawing this conclusion for stencils under Devito in general, until other stencils have been sampled.
