...
\begin{itemize}
	...
	\item Implementation of skewing/tiling and relevant tests in Devito (hopefully accepted; Chapter~\ref{ch:implementation})
	\item Evaluation of performance (Chapter~\ref{ch:evaluation})
\end{itemize}
