...
\begin{description}
	...
	\item[Vectorisation and time-tiling] Suspect something is going wrong, full length of inner dimension are slower than non-blockinner trials. Remark: fmax slow? (test this again)
\end{description}
