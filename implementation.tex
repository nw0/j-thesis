...
\begin{description}
	...
	\item[DSE aggressive mode] Devito uses my loop bounds one line before they are defined. Switch them round, run the test cases (and eyeball the loop structure).

	\item[Sparse loop interpolation] \clar{What is this?}
