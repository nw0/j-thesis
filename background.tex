...
Nevertheless, it is challenging to implement correctly in sufficient generality for Devito; in particular, we implement \emph{parameterised} time-tiling, which allows tile sizes to be changed at runtime.
