...
\begin{itemize}
	...
	\item We then discuss the requirements that time-tiling imposes on our use of Devito, and the considerations that it warrants (Section~\ref{sec:time-tiling-reqs}).
